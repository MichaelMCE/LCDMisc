...
// should put these in to an array then add accessor methods
int clipboardEvent;
...
int quitEvent;
int driveChangeEvent;
int deviceChangeEvent;
...
int InitEvents() {
	...
	static const InternalEventInfo internalEvents[] = {
		...
		{&driveChangeEvent, "DriveChange"},
		{&deviceChangeEvent, "DeviceChange"},
