...
inline int TriggerEvent (int id, __int64 v1, __int64 v2, __int64 v3, ScriptMode mode = CAN_WAIT) {
	ScriptValue sv1, sv2, sv3;
	CreateIntValue(sv1, v1);
	CreateIntValue(sv2, v2);
	CreateIntValue(sv3, v3);
	return TriggerEvent(id, mode, &sv1, &sv2, &sv3);
}
...
extern int driveChangeEvent;
extern int deviceChangeEvent;
