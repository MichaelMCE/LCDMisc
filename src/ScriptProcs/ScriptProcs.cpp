...
#include "ScriptObjects/ScriptImage.h"
#include "File.h"
...
int RegisterProcs2() {
	...
	const static ProcDescription desc[] = {
		...
		{"Is64Bit", Is64Bit, C_int},
		{"GetDesktopInfo", GetDesktopInfo, C_noArgs},
		{"IsAdmin", IsAdmin, C_noArgs},
		{"GetFocussedProcess", GetFocussedProcessPath, C_noArgs},
		...
		{"GetPowerStatus", GetPowerStatus, C_noArgs},
		...
		{"SaveSnapshot", SaveSnapshot, C_string},
...
/*
		...
		{"SetForegroundWindow", SetForegroundWindow, C_int},
		{"GetWindowText", MyGetWindowText, C_int},
		{"CloseWindow", CloseWindow, C_int},
		{"ShowWindow", ShowWindow, C_2ints},
		...
		{"IsImage", IsImage, C_obj},
		{"IsImage32", IsImage32, C_obj},
