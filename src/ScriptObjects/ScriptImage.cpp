...
void IsImage (ScriptValue &s, ScriptValue *args)
{
	CreateIntValue(s, (args[0].type == SCRIPT_OBJECT && args[0].objectVal->type == ImageType));
}

void IsImage32 (ScriptValue &s, ScriptValue *args)
{
	CreateIntValue(s, (args[0].type == SCRIPT_OBJECT && args[0].objectVal->type == Image32Type));
}


void NewImage32 (ScriptValue &s, ScriptValue *args)
{
	ObjectValue *o = s.objectVal;
	ScriptValue sv;

	if (CreateImage32(o->values[0], sv, args[0].i32, args[1].i32)) {
...
void Image32Blur (ScriptValue &s, ScriptValue *args)
{
	ObjectValue *o = s.objectVal;
	ScriptValue sv;

	if (Blur(o->values[0], sv, args[0].i32, args[1].i32)) {
		if (CreateObjectValue(s, Image32Type)) {
			s.objectVal->values[0] = sv;
			return;
		}
...
void Image32Copy (ScriptValue &s, ScriptValue *args)
{
	ObjectValue *o = s.objectVal;
	ScriptValue sv;

	if (Copy(o->values[0], sv)) {
		if (CreateObjectValue(s, Image32Type)) {
			s.objectVal->values[0] = sv;
			return;
		}
...
void Image32Fade (ScriptValue &s, ScriptValue *args)
{
	ObjectValue *o = s.objectVal;
	ScriptValue sv;

	if (Fade(o->values[0], sv, args[0].doubleVal, args[1].i32)) {
		if (CreateObjectValue(s, Image32Type)) {
			s.objectVal->values[0] = sv;
			return;
		}
...
void Image32Flip (ScriptValue &s, ScriptValue *args)
{
	ObjectValue *o = s.objectVal;
	ScriptValue sv;

	if (Flip(o->values[0], sv, args[0].i32)) {
		if (CreateObjectValue(s, Image32Type)) {
			s.objectVal->values[0] = sv;
			return;
		}
...
void Image32Pixelize (ScriptValue &s, ScriptValue *args)
{
	ObjectValue *o = s.objectVal;
	ScriptValue sv;

	if (Pixelize(o->values[0], sv, args[0].i32)) {
		if (CreateObjectValue(s, Image32Type)) {
			s.objectVal->values[0] = sv;
			return;
		}
...
void Image32Draw (ScriptValue &s, ScriptValue *args)
{
	ObjectValue *o = s.objectVal;

	if (args[0].type == SCRIPT_OBJECT && args[0].objectVal->type == Image32Type){
		if (Draw(o->values[0], args[0].objectVal->values[0], args[1].i32, args[2].i32, args[3].i32, args[4].i32, args[5].i32, args[6].i32)) {
			CreateIntValue(s, 1);
			return;
		}
	}
...
void Image32Clear (ScriptValue &s, ScriptValue *args)
{
	ObjectValue *o = s.objectVal;
	ScriptValue sv;

	if (!args[0].i32) args[0].i32 = 0xFF000000;

	if (Clear(o->values[0], sv, args[0].i32)) {
		CreateIntValue(s, 1);
		return;
	}
	CreateIntValue(s, 0);
