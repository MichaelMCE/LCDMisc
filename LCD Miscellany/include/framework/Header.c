...
function DisplayHeader ($res) {
	...
	if (IsNull($font))
		$font = Font("Arial", 32,0,0,0,CLEARTYPE_QUALITY);
	...
	DisplayTextShadowed(FormatTime("HH:NN:SS"), 6, -3, 0xB328F612, RGBA(255,255,255,240));
	DisplayTextRightShadowed(FormatTime("Ddd DD.MM.YY"), $width-3, -3, 0xB328C672, RGBA(255,255,255,240));
